...
Before submitting a bug, you should look at the [existing bug reports](https://github.com/Nitrux/xdg-desktop-portal-nx/issues) to verify that no one has reported the bug already.
